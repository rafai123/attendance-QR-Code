        ...
        <>
            <Container>
                <div className="row text-white">
                    <div className="col-lg-6 d-flex flex-column align-items-start  justify-content-center  " style={{minHeight: "80vh"}}>
                    ...
                    <div className="col-lg-6 d-flex justify-content-end align-items-center">
                        <img src={oopsImage} alt="Landing Page Image" className="hidden-lg" />
                    </div>    
                </div>
            </Container>
        </>
